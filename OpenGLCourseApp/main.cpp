...
void RenderPass(glm::mat4 projectionMatrix, glm::mat4 viewMatrix)
{
	...
	glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projectionMatrix)); // giving the shader our uniform projection value
	glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(viewMatrix)); // giving the shader our uniform view value
