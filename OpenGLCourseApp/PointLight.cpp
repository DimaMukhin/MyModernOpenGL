...
{
	glUniform3f(ambientColourLocation, colour.x, colour.y, colour.z); // send color to the shader
	glUniform1f(ambientIntensityLocation, ambientIntensity); // send ambient intensity to our shader
